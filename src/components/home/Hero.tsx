  ...
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8 py-32 w-full">
        <div className={`flex flex-col ${isArabic ? "lg:flex-row-reverse" : "lg:flex-row"} items-center gap-12 lg:gap-16`}>

          {/* Logo — shows first on mobile */}
          <div className="flex-shrink-0 lg:hidden opacity-0 animate-scale-in">
            <div className="relative">
              ...
              <Image
                ...
                height={200}
                priority
                className="relative rounded-full shadow-2xl shadow-primary/25 animate-float"
              />
            </div>
          </div>

          {/* Text content */}
          <div className={`flex-1 ${isArabic ? "max-w-4xl" : "max-w-3xl"}`}>
            {/* Small label */}
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/15 bg-primary/5 px-4 py-1.5 backdrop-blur-sm animate-fade-in">
          ...
          <div className="hidden lg:flex flex-shrink-0 items-center justify-center opacity-0 animate-scale-in" style={{ animationDelay: "300ms" }}>
            <div className="relative">
              {/* Outer glow */}
              <div className="absolute -inset-8 rounded-full bg-primary/15 blur-[60px]" />
              {/* Inner glow ring */}
              ...
              <Image
                ...
                height={380}
                priority
                className="relative rounded-full shadow-2xl shadow-primary/30 animate-float ring-1 ring-white/10"
              />
            </div>
          </div>
